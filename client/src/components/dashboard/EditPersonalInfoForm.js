...
const EditPersonalInfoForm = (props) => {
  ...
  const initialFormValues = {
    editEmail: props.profileInfo.email ? props.profileInfo.email : '',
    editFullname: props.profileInfo.fullname ? props.profileInfo.fullname : '',
    editCampus: props.profileInfo.campus ? props.profileInfo.campus : '',
    editCareer: props.profileInfo.current_job ? props.profileInfo.current_job : '',
    editLocation: props.profileInfo.location ? props.profileInfo.location : '',
    editRole: props.profileInfo.role ? props.profileInfo.role : '',
    editProgram: props.profileInfo.getPrograms.length ? props.profileInfo.getPrograms[0].name : '',
    editStudyYear: props.profileInfo.study_year ? props.profileInfo.study_year : '',
    editStudyCohort: props.profileInfo.study_cohort ? props.profileInfo.study_cohort : '',
    editMentor: props.profileInfo.getMentor ? props.profileInfo.getMentor : '',
	}
